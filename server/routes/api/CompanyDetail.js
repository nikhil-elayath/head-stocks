...
router.post("/financial/:id", async (req, res, next) => {
  try {
    ...
    if (req.body.yearInput) {
      startYear = req.body.yearInput;
      endYear = req.body.yearInput;
    } else {
      // financials
      startYear = 2008;
      endYear = 2019;
